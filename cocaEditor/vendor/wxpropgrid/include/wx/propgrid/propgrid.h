...
protected:
    ...
    */
    ...
    // added by Harm, for dragging support
    wxPGProperty*       m_propClick;
    wxPGProperty*       m_propDrag;
...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    // added by Harm
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_ITEM_DRAGGING,      wxPG_BASE_EVT_PRE_ID+9)
...
// added by Harm
#define EVT_PG_ITEM_DRAGGING(id, fn)         DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_ITEM_DRAGGING, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ),
