...
inline IrrXMLReader* createIrrXMLReader(const char* filename)
{
...
//! Creates an instance of an UFT-8 or ASCII character xml parser.
inline IrrXMLReader* createIrrXMLReader(FILE* file)
{
...
//! Creates an instance of an UFT-8 or ASCII character xml parser.
inline IrrXMLReader* createIrrXMLReader(IFileReadCallBack* callback)
{
...
inline IrrXMLReaderUTF16* createIrrXMLReaderUTF16(const char* filename)
{
...
//! Creates an instance of an UTF-16 xml parser.
inline IrrXMLReaderUTF16* createIrrXMLReaderUTF16(FILE* file)
{
...
//! Creates an instance of an UTF-16 xml parser.
inline IrrXMLReaderUTF16* createIrrXMLReaderUTF16(IFileReadCallBack* callback)
{
...
inline IrrXMLReaderUTF32* createIrrXMLReaderUTF32(const char* filename)
{
...
//! Creates an instance of an UTF-32 xml parser.
inline IrrXMLReaderUTF32* createIrrXMLReaderUTF32(FILE* file)
{
...
//! Creates an instance of an UTF-32 xml parser.
inline IrrXMLReaderUTF32* createIrrXMLReaderUTF32(IFileReadCallBack* callback)
{
